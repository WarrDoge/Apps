...
APPNAME = "TotemsHistory"
APIKEY = "Njg4N2M4OWItNWRjOS00OWFhLWJlZmQtZjExNGQ3YWE3YTUy"
APPID = "582f3b4d-09c4-4caf-9cd3-d0ac30f5377c"
SEGMENT_EU  = "EU"
SEGMENT_SNG  = "SNG"
SEGMENT_KZ  = "KZ"
SEGMENT_AZ  = "AZ"
...
schedule.every().monday.at(AU_EVENING_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_MONDAY_EVENING, AU_C_MONDAY_EVENING)

############## AU_TUESDAY_MORNING ###################

schedule.every().tuesday.at(AU_DAY_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_TUESDAY_MORNING, AU_C_TUESDAY_MORNING)

############## AU_TUESDAY_EVENING ###################

schedule.every().tuesday.at(AU_EVENING_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_TUESDAY_EVENING, AU_C_TUESDAY_EVENING)

############## AU_WEDNESDAY_MORNING ###################

schedule.every().wednesday.at(AU_DAY_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_WEDNESDAY_MORNING, AU_C_WEDNESDAY_MORNING)

############## AU_WEDNESDAY__EVENING ###################

schedule.every().wednesday.at(AU_EVENING_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_WEDNESDAY_EVENING, AU_C_WEDNESDAY_EVENING)

############## AU_THURSDAY_MORNING ###################

schedule.every().thursday.at(AU_DAY_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_THURSDAY_MORNING, AU_C_THURSDAY_MORNING)

############## AU_THURSDAY__EVENING ###################

schedule.every().thursday.at(AU_EVENING_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_THURSDAY_EVENING, AU_C_THURSDAY_EVENING)

############## AU_FRIDAY_MORNING ###################

schedule.every().friday.at(AU_DAY_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_FRIDAY_MORNING, AU_C_FRIDAY_MORNING)

############## AU_FRIDAY__EVENING ###################

schedule.every().friday.at(AU_EVENING_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_FRIDAY_EVENING, AU_C_FRIDAY_EVENING)

############## AU_SATURDAY_MORNING ###################

schedule.every().saturday.at(AU_DAY_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_SATURDAY_MORNING, AU_C_SATURDAY_MORNING)

############## AU_SATURDAY__EVENING ###################

schedule.every().saturday.at(AU_EVENING_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_SATURDAY_EVENING, AU_C_SATURDAY_EVENING)

############## AU_SUNDAY_MORNING ###################

schedule.every().sunday.at(AU_DAY_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_SUNDAY_MORNING, AU_C_SUNDAY_MORNING)

############## AU_SUNDAY__EVENING ###################

schedule.every().sunday.at(AU_EVENING_TIME).do(push_template, APPNAME, APIKEY, APPID, SEGMENT_AU, AU_H_SUNDAY_EVENING, AU_C_SUNDAY_EVENING)
